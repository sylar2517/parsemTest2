...
////    [[MainSession sharedSessionForScanText] removeInput:[MainSession sharedSession].imput];
////    [[MainSession sharedSessionForScanText] removeOutput:[MainSession sharedSession].output];
////    [[MainSession sharedSession] removeOutput:[MainSession sharedSession].outputText];
//   // [[MainSession sharedSession] commitConfiguration];
////    [[MainSession sharedSessionForScanText] initSessionForView:self.imageView forQRorText:NO];
//    [[MainSession sharedSessionForScanText] addOutPutForText:self];
//    [self detectText];
//    
...
////    } else {
//            dispatch_async([MainSession sharedSessionForScanText].sessionQueue, ^{
//                switch ([MainSession sharedSessionForScanText].setupResult) {
